...
The issue tracker should have been provided to you — run `/setup-project` if `ai-docs/agents/issue-tracker.md` is missing.
...
3. A PRD/spec file under `ai-docs/` (e.g. `ai-docs/plans/<feature>/PRD.md`) or `specs/` matching the branch name or feature.
