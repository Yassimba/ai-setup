...
-- Set in my.cnf: innodb_flush_method = O_DIRECT
...
-- For replication replicas or analytics (trade safety for speed)
...
```sql
-- Enable performance schema (my.cnf): performance_schema = ON
...
SELECT
    ...
    a.index_name as index1, a.column_name, b.index_name as index2
...
-- Add new partition
ALTER TABLE events ADD PARTITION (PARTITION p2026 VALUES LESS THAN (2027));
