---
name: marp-slide
description: Create Marp presentation slides — themed decks authored in Markdown.
  Use when the user asks for a Marp document or wants slides written in Markdown
  rather than .pptx.
---
...
6. Save to `ai-docs/slides/` with `.md` extension
...
Always save the final Marp file to `ai-docs/slides/` with `.md` extension:
- `presentation.md`
- `seminar-slides.md`
