...
describe("builtin agent overrides", () => {
	...
	it("bundled Pi agents inherit the default model while external workflow roles pin their required models", () => {
		...
		assert.deepEqual(
			...
			["deep-research-aggregator", "deep-research-proposer-codex", "deep-research-proposer-fable"],
		);
	});
